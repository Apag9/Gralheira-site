...
const historia = () => {
    return (
        <div>
            <h1 className={styles.historiatitle}>Explorando a História da Gralheira: Descubra os Segredos da Região</h1>
            <div className={styles.historiabox}>
                ...
                Embora pertença ao concelho de Cinfães, está mais ligada a Castro Daire pelas vias de comunicação e proximidade das povoações.
